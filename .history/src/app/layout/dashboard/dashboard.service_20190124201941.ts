...
export class DashboardService {
  ...
  getTripsEncours(id) {
    return this.http.get(`${this.url}/encours?id=`+id);
  
  }

  getTripsLivree(id) {
    return this.http.get(`${this.url}/livree?id=`+id);
  }

  getTripsAnnulee(id) {
    return this.http.get(`${this.url}/annulee?id=`+id);
  }

  getDriverActive() {
    return this.http.get(`${this.urlD}/activelast`);
  }
  getTripRetournee(id) {
