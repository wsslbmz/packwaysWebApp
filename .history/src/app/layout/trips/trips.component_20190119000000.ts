...
export class TripsComponent implements OnInit {
    ...
    constructor(private modalService: NgbModal,public adressService: AdresseService, private tservice: TripService,
         public loginService: LoginService, public http: Http, public sanitizer: DomSanitizer, public router: Router, private spinner: NgxSpinnerService) {
    ...
    onChangeDisplayedElement() {
        let showTime = 5000;
        if (this.chooseView === 'all') {
            showTime = 20000;
        } else if (this.chooseView === '500' || this.chooseView === '400' || this.chooseView === '300') {
            showTime = 14000;
        } else if (this.chooseView === '200') {
            showTime = 10000;
        } else if (this.chooseView === '150') {
            showTime = 7000;
        } else {
            showTime = 2000;
        }
