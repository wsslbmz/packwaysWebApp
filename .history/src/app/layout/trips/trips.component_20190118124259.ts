...
export class TripsComponent implements OnInit {
  ...
  edit: any;
    ...
    ngOnInit() {
        this.getTrips();
        this.numDisplayedElement = 20;
        $('#displayedNumber').val('Eléments affichés: ' + this.numDisplayedElement);
        //this.getTripsOnInit();
    ...
    getTrips() {
        ...
        this.jsonObj = null;
        this.items = [];
        if (this.numDisplayedElement === null) {
            this.sizeListTrip = 20;
        } else {
            this.sizeListTrip = this.numDisplayedElement;
        }
        this.sizeListTrip = 50;
