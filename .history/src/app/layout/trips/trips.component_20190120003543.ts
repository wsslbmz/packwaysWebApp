    ...
    filterItems(searchTerm) {
      ...
      setFilteredItems() {
        ...
        if (this.items !== undefined) {
          ...
          console.log('itemsSearch: ', this.itemsSearch);
