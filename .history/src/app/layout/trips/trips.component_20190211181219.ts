...
export class TripsComponent implements OnInit {
    ...
    getFiltredTripsOnNext() {                        
        if (this.items.length !== 0) {
            ...
            this.getFiltredTrips1(this.splitDateFormatMDY(this.startDateFilter), nextTripDate, this.searchTerm, this.clientFilter,
                this.stateFilter, this.enRetardFilter, this.payementStatusFilter, null);
        } else {
            console.log('this.items.length === 0');
            this.prvBtnDisabled = true;            
            //this.getFiltredTrips(null, this.searchTerm, null);
            this.getFiltredTrips1(this.splitDateFormatMDY(this.startDateFilter), this.splitDateFormatMDY(this.endDateFilter), this.searchTerm, this.clientFilter,
                this.stateFilter, this.enRetardFilter, this.payementStatusFilter, null);
        }        
    }
    ...
    getFiltredTripsOnPrevious() {                
        if (this.items.length !== 0) {
            ...
            this.getFiltredTrips1(this.splitDateFormatMDY(this.startDateFilter), prevTripDate, this.searchTerm, this.clientFilter,
                this.stateFilter, this.enRetardFilter, this.payementStatusFilter, null);
        } else {            
            this.prvBtnDisabled = true;            
            //this.getFiltredTrips(null, this.searchTerm, null);
    ...
    deleteTrip(trip) {
        ...
        || ( (trip.statusTrip !== 'Livree') && (!(trip.isClosed)) ) ) ) {
            ...
            console.log('Impossible de supprimer le colis');
        }


        if (localStorage.getItem('auth') !== 'admin' && (trip.statusTrip !== 'cherche un livreur' || trip.statusTrip !== 'Livreur en chemin' || trip.statusTrip !== '')) {
