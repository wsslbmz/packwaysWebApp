    ...
    addTrip() {
        ...
        const c = $('#cityGlobalDest').val();
            ...
            if (a === '' || b === '' || c === '') {
                ...
                return;
            } else if (this.selectedAdresseExp === '') {
                console.log('selectedAdresseExp vide');
            } else if (this.selectedAdresseExp === undefined) {
                console.log('selectedAdresseExp undif');
            } else if (this.selectedAdresseExp === null) {
                console.log('selectedAdresseExp null');
            } else {
                console.log('okkkk');
            }
