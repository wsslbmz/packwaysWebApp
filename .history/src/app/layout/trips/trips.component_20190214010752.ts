...
export class TripsComponent implements OnInit {
    ...
    tripsFromExcel: AOA;
    jsonExcelObj: any;
    tunisiaData: any[] = ['cherche un livreur', 'Livreur en chemin', 'Chez Livreur', 'livraison en cours', 'Livree', 'Annulée', 'Retour'];
    ...
    openAddModal(content) {  
        ...
        const zip = $( '#zipCode' );
        const gouvernorat2 = $( '#gouvernorat2' );
        TunisiaGovAndDelg.findGovAndDelegByZipCode(key, gouvernorat, delegation, compoAdr, zip, gouvernorat2);
    }
    ...
    onFileChange(evt: any) {
		...
		reader.onload = (e: any) => {
			...
			/* save data */
            this.tripsFromExcel = <AOA>(XLSX.utils.sheet_to_json(ws, {header: 1}));            
		};
