...
export class TripsComponent implements OnInit {
    ...
    getFiltredTrips1(dateTp, dateTp2, keyTp, keyTp1, keyTp2, keyTp3, keyTp4, btnTp) {
        ...
        if (dateTp != null) {
            this.dateFiltredTrip = this.changeDateFormatDMY(dateTp);
        } else {
            this.dateFiltredTrip = '';
        }
        if (dateTp2 != null) {
            this.dateFiltredTrip2 = this.changeDateFormatDMY(dateTp2);
        } else {
    ...
    getFiltredTripsOnNext() {                        
        if (this.items.length !== 0) {
            ...
            this.getFiltredTrips1(this.startDateFilter, nextTripDate, this.searchTerm, this.clientFilter,
                this.stateFilter, this.enRetardFilter, this.payementStatusFilter, null);
        } else {
