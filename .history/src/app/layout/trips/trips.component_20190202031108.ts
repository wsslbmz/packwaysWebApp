...
export class TripsComponent implements OnInit {
    ...
    addTrip() {
        ...
        if (this.selectedAdresseDest != null) {
            ...
            labelAdrD = this.cityAdresseDest;
        }
        console.log(this.selectedAdresseExp.labelAdr);
        console.log(labelAdrD);
        console.log((<HTMLInputElement>document.getElementById('inputDestAdresseCity')).value);
