...
export class TripsComponent implements OnInit {
    ...
    editTrip(content, trip) {
        ...
        let key = this.zipCodeUp;        
        const compoAdr = $( '#cityGlobalDestUp' );
        const zip = $( '#zipCodeUp' );                
        TunisiaGovAndDelg.loadGovAndDelegOfTunisia(gouvernoratUp, delegationUp);
        //TunisiaGovAndDelg.findGovAndDelegByZipCode(key, gouvernoratUp, delegationUp, compoAdr, zip);
