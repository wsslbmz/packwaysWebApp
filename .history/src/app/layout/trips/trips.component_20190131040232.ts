...
export class TripsComponent implements OnInit {
    ...
    editTrip(content, trip) {        
        ...
        let key = 8020;
        TunisiaGovAndDelg.findGovAndDelegByZipCode(key);
    ...
    updatetrip() {
        let stat = this.objTrip.statusTrip;
        if ((stat !== 'cherche un Livreur' && (this.driver === null || this.driver === '' || this.driver === undefined))
         || (stat === 'Livreur en chemin' && this.objTrip.getedday === '')  || (stat === 'Chez Livreur' && this.objTrip.affectedday === '') 
         || (stat === 'livraison en cours' && this.objTrip.startdelday === '') || (stat === 'Livree' && this.objTrip.livredday === '')  
         || (stat === 'Annulée' && this.objTrip.returnedday === '') || (stat === 'Retour' && this.objTrip.returnedday === '')) {
