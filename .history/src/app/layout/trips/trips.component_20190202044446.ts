...
export class TripsComponent implements OnInit {
    ...
    ngOnInit() {
        //this.getTrips();
        this.getFiltredTrips(null, null, null, null, null);                
        // this.getTripsOnInit();
    ...
    getFiltredTrips(idUserTp, dateTp, sizeTp, keyTp, btnTp) {
        this.auth =localStorage.getItem('auth');
        console.log("login",this.auth);
        this.currentUser = JSON.parse(localStorage.getItem('currentUser'));
        this.dataUser = this.currentUser.data[0];
        ...
        if (idUserTp != null) {
            this.idUserFiltredTrip = idUserTp;
        } else {
            this.idUserFiltredTrip = this.id;
        }
        ...
        if (sizeTp != null) {
            this.sizeFiltredTrip = sizeTp;
        } else {
            this.sizeFiltredTrip = '';
        }
        if (keyTp != null) {
        ...
        this.tservice.getFiltredTrips(this.idUserFiltredTrip, this.dateFiltredTrip, this.sizeFiltredTrip, this.keyFiltredTrip, this.btnFiltredTrip).subscribe(data => {
            this.result = data['_body'];
    ...
    filterItems(searchTerm) {
      ...
      setFilteredItems() {
        ...
        this.getFiltredTrips(null, null, null, 'Retour', null);
