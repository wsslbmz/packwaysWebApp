...
export class ExcelService {
  ...
  generateExcel() {
    ...
    worksheet.addRow([]);
    const subTitleRow = worksheet.addRow(['Date : ' + formatDate(new Date(), 'd MMM yy HH:mm', 'fr')]);
    ...
    workbook.xlsx.writeBuffer().then((data) => {
      const blob = new Blob([data.toString()], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
