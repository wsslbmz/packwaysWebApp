...
export class TripsComponent implements OnInit {
    ...
    showStatusTrip2(trip) {
        ...
        if (trip.affectedday != null) {
          const dacceptation = new Date(trip.affectedday).getTime();
          const diff = this.dnow - dacceptation;
          if ((diff >=  dif) && (trip.statusTrip === 'Livreur en chemin')) {
            this.refColor = true;
          } else {
              this.refColor = false;
          }
