...
export class TripsComponent implements OnInit {
    ...
    editTrip(content, trip) {
        let drv = this.getSelectedDriver(trip.driverTrip);
    ...
    getSelectedDriver(driverTrip) {
        if (driverTrip !== null) {
            console.log('driverTrip.idDriver', driverTrip.idDriver);
            console.log('this.Listdriver', this.Listdriver);
            for(let i = 0; i < this.Listdriver.lenght; i++) {
                console.log('this.Listdriver[i]', this.Listdriver[i]);
