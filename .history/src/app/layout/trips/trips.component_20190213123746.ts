...
export class TripsComponent implements OnInit {
    ...
    Upload() {
        ...
        fileReader.onload = (e) => {
            ...
            this.jsonExcelObj = XLSX.utils.sheet_to_json(worksheet, {raw: true});
            this.jsonExcelObj.forEach(element => {
                console.log('element', element);
                this.tripsFromExcel.push(element);
            });
            /* console.log(this.jsonExcelObj); 
            for (let index = 0; index < this.jsonExcelObj.length; index++) {
                this.tripsFromExcel.push(this.jsonExcelObj[index]);
            } */
            console.log(this.tripsFromExcel);
            //console.log('tripsFromExcel[0]', this.tripsFromExcel[0]);
            //console.log('tripsFromExcel[2]', this.tripsFromExcel[2]);
        }        
