...
addAdresse() {
  ...
  console.log('mmmm444 ', this.markers);
...
deleteAdresse(adresse) {
  ...
  getLatLngByAddress() {
    const address = this.delegation;
    console.log('deleg ', this.delegation);
  ...
  getLatitudeLongitudeFromAddress(callback, address) {
    ...
    console.log('mmmm ', this.markers);
    this.markers = [];
    console.log('mmmm222 ', this.markers);
  ...
  loadPosByLatLng() {
    ...
    this.markers.push({
      lat: 36.3639365,
      lng: -96.04876190000004,
      draggable: true
    });
    console.log('mmmm333 ', this.markers);
  }
}
