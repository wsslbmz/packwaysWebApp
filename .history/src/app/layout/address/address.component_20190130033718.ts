...
deleteAdresse(adresse) {
  ...
  loadPosByLatLng() {
    this.latitude = (<HTMLInputElement>document.getElementById('latitude2')).valueAsNumber;
    this.longitude = (<HTMLInputElement>document.getElementById('longitude2')).valueAsNumber;
    console.log($( '#latitude2' ).val() + '***' + $( '#longitude2' ).val());
