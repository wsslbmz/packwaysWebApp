...
export class AddressComponent implements OnInit {
  ...
  initMapInModal() {
    ...
    this.latitudeInit = 36.833980;
    this.longitudeInit = 10.139880;
...
addAdresse() {
  if (this.latitudeInit !== this.latitude || this.longitudeInit !== this.longitude) {
    this.latGlobal = $('#latitude2').val();
    this.lngGlobal = $('#longitude2').val();
    this.cityGlobal = $('#inputComposedAdresse').val();
  } else {
