 ...
 changeDateFormatMDY(dd){
    ...
    generateExcel() {
        ...
        () => {
            ...
            this.excelService.generateExcel(this.tripsByUserAndDate, nameuser, this.changeDateFormatDMY2(this.startDate), this.changeDateFormatDMY2(this.endDate));
            // this.spinner.hide();
        });
