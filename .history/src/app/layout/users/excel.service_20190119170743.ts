...
export class ExcelService {
 data: any;
  ...
  generateExcel(idUsr, dateD, dateF) {    
    ...
    const header = ['REF', 'Status du colis', 'Frais de livraison', 'Ville de destination', 'Date d\'expédition', 'Date de livraison', 'Montant du colis'];
      this.data = this.userService.getTripsByUserAndDate(idUsr, dateD, dateF);
      /* [
