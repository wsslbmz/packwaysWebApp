...
export class ExcelService {
 data: any; 
  ...
  generateExcel(tripsData, nameuser, startDate, endDate) {
    ...
    const header = ['REF', 'Status', 'Frais', 'Ville de destination', 'Date postulation',
     'Date ramassage', 'Date livraison', 'Clôture', 'Montant'];
      this.data = tripsData;
    ...
    worksheet.getColumn(4).alignment = {vertical: 'middle', horizontal: 'right'};
