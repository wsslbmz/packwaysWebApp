...
export class UsersComponent implements OnInit {
 ...
 getTripsByUserAndDate() {
    ...
    generateExcel() {
        ...
        console.log('idUs: ', this.idUserTr);
        console.log('sDate: ', this.changeDateFormatMDY(this.startDate));
        console.log('eDate: ', this.changeDateFormatMDY(this.endDate));
        this.tripsByUserAndDate = this.userService.getTripsByUserAndDate(this.idUserTr, this.changeDateFormatMDY(this.endDate), this.changeDateFormatMDY(this.startDate));
