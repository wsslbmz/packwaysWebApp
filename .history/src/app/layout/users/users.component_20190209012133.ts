 ...
 changeDateFormatMDY(dd){
    ...
    generateExcel() {
        ...
        () => {
            ...
            let stDate = (<HTMLInputElement>document.getElementById('startDate')).value;
            let edDate = (<HTMLInputElement>document.getElementById('endtDate')).value;
            this.excelService.generateExcel(this.tripsByUserAndDate, nameuser, stDate, edDate);
            // this.spinner.hide();
        });
