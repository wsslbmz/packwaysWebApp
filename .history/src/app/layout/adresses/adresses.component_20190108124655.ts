...
export class AdressesComponent implements AfterViewInit {
    ...
    @ViewChild('searchTextFiel') sosearchTextFielmeInput: ElementRef;



    // tslint:disable-next-line:max-line-length
    constructor(private modalService: NgbModal, private tservice: AdresseService, public http: Http, public sanitizer: DomSanitizer, public searchTextFiel: ElementRef) {}
    ...
    autoMaps() {
        const el: HTMLInputElement = this.searchTextFiel.nativeElement.querySelector('#searchTextFiel');
        const searchTextFiel = document.getElementById('searchTextFiel');
        const autocomplete = new google.maps.places.Autocomplete(searchTextFiel);
