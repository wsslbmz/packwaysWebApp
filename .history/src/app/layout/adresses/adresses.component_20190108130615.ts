...
export class AdressesComponent implements OnInit {
    ...
    openAddModal(content) {
        ...
        const searchTextFiels: HTMLInputElement = this.elementRef.nativeElement.querySelector('#searchTextFiel');
        // const searchTextFiels = document.getElementById('searchTextFiel');
        const autocomplete = new google.maps.places.Autocomplete(searchTextFiels);
        console.log(searchTextFiels);
