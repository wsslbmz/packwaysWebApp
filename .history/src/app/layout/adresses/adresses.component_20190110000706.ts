...
export class AdressesComponent implements OnInit {
    ...
    ngOnInit() {
        this.getAdressess();
        this.latGlobal = '33.888077';
        this.lngGlobal = '8.888077';
    ...
    searchPlaces() {
        ...
        searchBox.addListener('places_changed', function() {
          ...
          $('#idimgmap').attr('src', 'https://maps.googleapis.com/maps/api/staticmap?center=' + this.latGlobal + ',' + this.lngGlobal + '&zoom=12&size=800x320&markers=color:red%7Clabel:D%7C' + this.latGlobal + ',' + this.lngGlobal + '&maptype=roadmap&key=AIzaSyDfv9xCJhmLahpNkDvNDUmZ8jSkHiA19oE');
       });
 ...
 */
      addNumToList() {
          ...
          console.log(this.imgAdresse);
          console.log((<HTMLInputElement>document.getElementById('imgtest')).files[0]);
     ...
     addAdresse() {
        this.tservice.addadress(this.latGlobal, this.lngGlobal, null, null, this.labelAdresse, this.nomContact, this.telContact, this.typeAdresse, this.list, null, this.cityGlobal, this.imgAdresse);
     }
