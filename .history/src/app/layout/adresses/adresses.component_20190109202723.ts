...
export class AdressesComponent implements OnInit {
    ...
    searchPlaces() {
        ...
        searchBox.addListener('places_changed', function() {
          ...
          $('#idstatmap').show();
          $('#idimgmap').attr('src','https://maps.googleapis.com/maps/api/staticmap?center={{latGlobal}},{{lngGlobal}}&zoom=12&size=800x320&markers=color:red%7Clabel:D%7C{{latGlobal}},{{lngGlobal}}&maptype=roadmap&key=AIzaSyDfv9xCJhmLahpNkDvNDUmZ8jSkHiA19oE');
       });
