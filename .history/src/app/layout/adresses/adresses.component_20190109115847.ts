...
export class AdressesComponent implements OnInit {
    ...
    autoMaps() {
      ...
      searchPlaces() {
        const st = document.getElementById('inputNewNomAdresse');
        const searchBox = new google.maps.places.SearchBox(st);
        // Listen for the event fired when the user selects a prediction and retrieve
        // more details for that place.
                //  console.log(this.st);
        //  console.log(autocomplete);
        // const autocomplete = new google.maps.places.Autocomplete(st);
