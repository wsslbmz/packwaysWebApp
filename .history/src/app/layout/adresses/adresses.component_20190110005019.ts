 ...
 */
     ...
     addAdresse() {
        this.tservice.addadress(this.latGlobal, this.lngGlobal, null, null, this.labelAdresse, this.nomContact, this.telContact, this.typeAdresse, this.list, null, this.cityGlobal, this.base64textString[0]);
     }
